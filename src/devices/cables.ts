export const CABLE_OPTIONS = [
  ...
  { value: 'audio_ts_trs_combined', label: 'TS/TRS combined' },
  { value: 'audio_jack_to_minijack', label: 'Jack to Minijack' },
  { value: 'audio_minijack_to_trs', label: 'Minijack to TRS' },
  { value: 'audio_minijack_to_dual_trs', label: 'Minijack to Dual TRS' },
  { value: 'audio_trs_to_dual_trs', label: 'TRS to TRS (Y Cable)' },
